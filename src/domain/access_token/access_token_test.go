...
func TestGetNewAccessToken(t *testing.T) {
	...
	assert.False(t, at.IsExpired(), "band new access token should not be expired")

	assert.EqualValues(t, "", at.AccessToken, "brand new access token should have empty string token")
